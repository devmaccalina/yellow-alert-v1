...
// node_modules/react-signature-pad-wrapper/dist/react-signature-pad-wrapper.es.js
...
var n = function(t2, e) {
  return n = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t3, e2) {
    ...
    for (var r in e2)
      Object.prototype.hasOwnProperty.call(e2, r) && (t3[r] = e2[r]);
  }, n(t2, e);
};
var i = function() {
  return i = Object.assign || function(t2) {
    for (var e, r = 1, n2 = arguments.length; r < n2; r++)
      for (var i2 in e = arguments[r])
        Object.prototype.hasOwnProperty.call(e, i2) && (t2[i2] = e[i2]);
    return t2;
  }, i.apply(this, arguments);
};
var o = function(o2) {
  function a(e) {
    var n2 = o2.call(this, e) || this;
    return n2.canvasRef = t.createRef(), n2.state = { canvasWidth: 0, canvasHeight: 0 }, n2.callResizeHandler = debounce(n2.props.debounceInterval, n2.handleResize.bind(n2)), n2;
  }
  return function(t2, e) {
    ...
    n(t2, e), t2.prototype = null === e ? Object.create(e) : (r.prototype = e.prototype, new r());
  }(a, o2), a.prototype.componentDidMount = function() {
    var t2 = this.canvasRef.current;
  ...
  }, Object.defineProperty(a.prototype, "instance", { get: function() {
    return this.signaturePad;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "canvas", { get: function() {
    return this.canvasRef;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "dotSize", { get: function() {
    return this.signaturePad.dotSize;
  }, set: function(t2) {
    this.signaturePad.dotSize = t2;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "minWidth", { get: function() {
    return this.signaturePad.minWidth;
  }, set: function(t2) {
    this.signaturePad.minWidth = t2;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "maxWidth", { get: function() {
    return this.signaturePad.maxWidth;
  }, set: function(t2) {
    this.signaturePad.maxWidth = t2;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "throttle", { get: function() {
    return this.signaturePad.throttle;
  }, set: function(t2) {
    this.signaturePad.throttle = t2;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "backgroundColor", { get: function() {
    return this.signaturePad.backgroundColor;
  }, set: function(t2) {
    this.signaturePad.backgroundColor = t2;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "penColor", { get: function() {
    return this.signaturePad.penColor;
  }, set: function(t2) {
    this.signaturePad.penColor = t2;
  }, enumerable: false, configurable: true }), Object.defineProperty(a.prototype, "velocityFilterWeight", { get: function() {
    return this.signaturePad.velocityFilterWeight;
  }, set: function(t2) {
    this.signaturePad.velocityFilterWeight = t2;
  }, enumerable: false, configurable: true }), a.prototype.isEmpty = function() {
    return this.signaturePad.isEmpty();
  }, a.prototype.clear = function() {
    this.signaturePad.clear();
  }, a.prototype.fromDataURL = function(t2, e) {
    void 0 === e && (e = {}), this.signaturePad.fromDataURL(t2, e);
  }, a.prototype.toDataURL = function(t2, e) {
    return this.signaturePad.toDataURL(t2, e);
  }, a.prototype.toSVG = function(t2) {
    return this.signaturePad.toSVG(t2);
  }, a.prototype.fromData = function(t2) {
  ...
  }, a.prototype.scaleCanvas = function(t2) {
    var e = Math.max(window.devicePixelRatio || 1, 1), r = (this.props.width || t2.offsetWidth) * e, n2 = (this.props.height || t2.offsetHeight) * e, i2 = this.state, o3 = i2.canvasWidth, a2 = i2.canvasHeight;
    if (r !== o3 || n2 !== a2) {
      var s;
      this.props.redrawOnResize && this.signaturePad && !this.signaturePad.isEmpty() && (s = this.signaturePad.toDataURL()), t2.width = r, t2.height = n2, this.setState({ canvasWidth: r, canvasHeight: n2 });
      var u = t2.getContext("2d");
      u && u.scale(e, e), s ? this.signaturePad.fromDataURL(s) : this.signaturePad && this.signaturePad.clear();
    }
  }, a.prototype.render = function() {
    var e = this.props.canvasProps;
    return t.createElement("canvas", i({ "data-testid": "canvas-element", ref: this.canvasRef }, e));
  }, a.displayName = "react-signature-pad-wrapper", a.defaultProps = { redrawOnResize: false, debounceInterval: 150 }, a;
}(t.PureComponent);
export {
  o as default
};
