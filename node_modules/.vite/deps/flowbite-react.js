    ...
    if ((0, import_react5.isValidElement)(child)) {
      if (child.props.children) {
        return (0, import_react5.cloneElement)(child, {
          ...
          positionInGroup: determinePosition(index, import_react5.Children.count(children))
        });
      } else {
        return (0, import_react5.cloneElement)(child, {
          outline,
...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponentFn = (0, import_react6.forwardRef)(({ children, className, color = "info", disabled, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner, gradientDuoTone, gradientMonochrome, label, outline = false, pill = false, positionInGroup = "none", size = "md", theme: customTheme = {}, ...props }, ref) => {
...
var DropdownItem = (0, import_react21.forwardRef)(({ children, className, icon: Icon, onClick, theme: customTheme = {}, ...props }, forwardedRef) => {
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const handleSelect = (0, import_react23.useCallback)((index) => {
    setSelectedIndex(index);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react23.useCallback)((index) => {
    if (open) {
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react29.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
...
// node_modules/flowbite-react/lib/esm/components/Table/TableBody.js
var TableBody = (0, import_react46.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableCell = (0, import_react47.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/lib/esm/components/Table/TableHead.js
var TableHead = (0, import_react49.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
  const { theme: rootTheme } = useTableContext();
...
var TableHeadCell = (0, import_react50.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableRow = (0, import_react51.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = (0, import_react52.forwardRef)(({ children, className, striped, hoverable, theme: customTheme = {}, ...props }, ref) => {
...
var TabsComponent = (0, import_react53.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().tabs, customTheme);
  const id = (0, import_react53.useId)();
  const tabs = (0, import_react53.useMemo)(() => import_react53.Children.map(import_react53.Children.toArray(children), ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react53.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react53.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react53.useState)(-1);
...
var Textarea = (0, import_react54.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
...
var TimelineContentContext = (0, import_react55.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react55.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineContext = (0, import_react56.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react56.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react57.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react57.useContext)(TimelineItemContext);
  if (!context) {
...
var ToastContext = (0, import_react58.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react58.useContext)(ToastContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react59.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react59.useState)(false);
...
var ToggleSwitch = (0, import_react60.forwardRef)(({ checked, className, color = "blue", sizing = "md", disabled, label, name, onChange, theme: customTheme = {}, ...props }, ref) => {
...
function Popover({ children, content, theme: customTheme = {}, arrow: arrow2 = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...props }) {
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react61.useState)(Boolean(initialOpen));
  ...
  const target = (0, import_react61.useMemo)(() => {
    return (0, import_react61.cloneElement)(children, getReferenceProps({
      ref,
